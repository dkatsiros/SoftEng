...
INSERT INTO `application_user` VALUES (1,'admin','$2a$10$w7A5wWV1QJHUSc3x4zSYpe0mV0RKBc.fAQ9sf.PkW1HindEMNYCdy','adas','xasxc','dwdqwd',0),(2,'admin4','$2a$10$BwbjN/IvD.PeOfkEL1NYu.ndFO1Nx5NP87FwKxnXwDOZPkKvFuwZ2','sda','da','asx',0);
...
INSERT INTO `price` VALUES (1,'2017-03-21','2018-12-12',1.4,0,0,1,1),(2,'2018-04-12','2020-01-19',1.5,0,0,1,2),(3,'1977-12-03','1987-03-12',1.4,0,0,1,3),(4,'1977-12-03','1987-03-12',1.4,0,0,4,3),(5,'1977-12-03','1987-03-12',1.4,0,0,3,3),(6,'1977-12-03','1987-03-12',1.4,0,0,3,2);
...
INSERT INTO `shop` VALUES (1,'Μεσολλογγίου 13, Καστοριά',35.5137,24.0173,'Mc','cafes, magazi, apo kastoria paok',0),(2,'Μεσολλογγίου 13, Καστοριά',13.7,12.3,'Mc','cafes, magazi, apo kastoria paok, velanidia',0),(3,'Μεσολλογγίου 13, Καστοριά',13.7,12.3,'Mc','cafes, magazi, apo kastoria paok',0),(4,'Μεσολλογγίου 13, Καστοριά',13.7,12.3,'Mc','cafes, magazi, apo kastoria paok',0);
...
-- Dump completed on 2019-02-28 12:48:33
